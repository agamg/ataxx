...
class Move {
    ...
    private Move(int col0, int row0, int col1, int row1) {
        ...
        _isExtend = (possibleExtensions.contains(_toIndex - _fromIndex));
        _isJump = (possibleJumps.contains(_toIndex - _fromIndex));
    }
    ...
    /** possibleExtensions. */
    private ArrayList<Integer> possibleExtensions = new
            ArrayList<>(Arrays.asList(-1, 1, 10, 11, 12, -12, -11, -10));
    /** possibleJumps. */
    private ArrayList<Integer> possibleJumps = new
            ArrayList<>(Arrays.asList(-2, 2, -9, 9, -13,
            13, -20, 20, -21, -22, -23, -24, 21, 22, 23, 24));
}
